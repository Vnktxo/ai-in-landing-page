...
const Hero = () => {
  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent) => {
      e.preventDefault();
      if (!formData.email || !formData.name || !formData.phone || isLoading)
        return;
  ...
  return (
    <>
      ...
      <section
        id="hero"
        className="relative pt-32 pb-20 bg-gradient-to-b from-[#0D0D0D] text-[#E0E0E0] min-h-screen flex items-center overflow-hidden w-full"
      >
        <div className="absolute inset-0 bg-hero-pattern opacity-30"></div>
        <div className="absolute top-20 left-10 w-96 h-96 bg-[#00FFA3]/20 rounded-full blur-3xl animate-pulse"></div>
        <div
          className="absolute bottom-20 right-10 w-96 h-96 bg-[#00FFA3]/10 rounded-full blur-3xl animate-pulse"
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-12 items-center">
            <div className="lg:col-span-7">
              ...
              <h1 className="text-5xl sm:text-7xl font-extrabold tracking-tight mb-6 leading-tight">
                ...
                <span className="block text-[#00FFA3] drop-shadow-[0_0_20px_rgba(0,255,163,0.5)]">
                  8 Saturdays
                </span>
              </h1>
              <p className="mt-6 text-xl sm:text-2xl text-[#E0E0E0] max-w-2xl leading-relaxed">
                ...
                employers&apos; actually want. Level up from AI-curious to
                AI-capable with 20+ powerful AI tools set to dominate 2026 —
                stay ahead, stay future-ready.
              </p>
              ...
              <div
                className="mt-12 p-8 bg-[#1A1A1A] border-2 border-[#00FFA3]/30 rounded-2xl shadow-2xl shadow-[#00FFA3]/10"
                id="enroll"
              >
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
                  <h2 className="text-2xl font-bold text-[#E0E0E0]">
                    Secure Your Seat Right away
                  </h2>
                ...
                <div className="mt-6 flex flex-col sm:flex-row gap-4 text-sm text-[#E0E0E0]/70">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-[#00FFA3]">✓</span>
                    <span>Batch 1 Starts Jan 3rd</span>
                  </div>
                </div>
              </div>
            </div>
