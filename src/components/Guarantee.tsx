...
const Guarantee = () => {
  return (
    <section className="w-full py-20 lg:py-24 bg-transparent ">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto bg-[#0D0D0D]/50 backdrop-blur-3xl p-8 rounded-xl shadow-xl flex flex-col items-center text-center">
